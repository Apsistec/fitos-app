...
@Component({
  selector: 'app-gym-owner-register',
  standalone: true,
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Gym Owner Registration</ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content class="ion-padding">
      <div class="register-container">
        ...
        <div class="register-header">
          ...
          <p class="subtitle">Manage your facility, staff, and member experience</p>
        </div>
        ...
        <form [formGroup]="registerForm" (ngSubmit)="onSubmit()">
          <div class="form-fields">
            <ion-input
              ...
              helperText="Your name as the account owner"
        ...
        <!-- Info Note -->
        <div class="info-note">
          <p>After registration, you'll be able to set up your gym profile, add trainers, and configure member management.</p>
        </div>
        ...
        <div class="signin-link">
          <p>
            ...
            <a routerLink="/auth/login/gym-owner">Sign in</a>
          </p>
        </div>
      </div>
    </ion-content>
...
export class GymOwnerRegisterPage {
  ...
  constructor() {
    addIcons({ businessOutline, checkmarkCircle, closeCircle, logoGoogle, logoApple });
  }
  ...
  async signUpWithGoogle(): Promise<void> {
    ...
    const { error } = await this.authService.signUpWithProvider('google', 'gym_owner');
  ...
  async onSubmit(): Promise<void> {
    ...
    try {
      ...
      if (error) {
        ...
        await this.router.navigate(['/auth/login/gym-owner']);
