...
import { peopleOutline, checkmarkCircle, closeCircle, logoGoogle, logoApple } from 'ionicons/icons';
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Client Registration</ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content class="ion-padding">
      <div class="register-container">
        ...
        <div class="register-header">
          ...
          <p class="subtitle">Track workouts, nutrition, and work with your trainer</p>
        </div>
        ...
        <form [formGroup]="registerForm" (ngSubmit)="onSubmit()">
          <div class="form-fields">
            <ion-input
              ...
              helperText="Your name as it will appear to your trainer"
        ...
        <div class="signin-link">
          <p>
            ...
            <a routerLink="/auth/login/client">Sign in</a>
          </p>
        </div>
      </div>
    </ion-content>
...
export class ClientRegisterPage {
  ...
  constructor() {
    addIcons({ peopleOutline, checkmarkCircle, closeCircle, logoGoogle, logoApple });
  }
  ...
  async signUpWithGoogle(): Promise<void> {
    ...
    const { error } = await this.authService.signUpWithProvider('google', 'client');
  ...
  async onSubmit(): Promise<void> {
    ...
    try {
      ...
      if (error) {
        ...
        await this.router.navigate(['/auth/login/client']);
